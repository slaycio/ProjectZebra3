...
public final class DataModel {
	...
	public final static JPAContainer<AccountOwner> accountOwners = JPAContainerFactory.make(AccountOwner.class, "ProjectZEBRA3");
	public final static JPAContainer<User> users = JPAContainerFactory.make(User.class, "ProjectZEBRA3");
